...
c9 = Edge;
CB = 0;
%% Edge Remover by Psi Note: Psi here considered Nx4 not Nx5 maybe in future quadrangular would add that require 1 more
if psi == 0
else
for i = 1:1:numel(psi(:,1)) %Counter for edges
if psi(i,4) == 1
  j = 1;
